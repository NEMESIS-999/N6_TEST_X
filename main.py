            ...
            while True:
                ...
                if data2.hex().startswith('0500') and len(data2.hex()) > 1000:
                    try:
                        ...
                        message = f'[B][C]{get_random_color()}\n- مرحبا بكم في بوت رقصات !WELCOME TO THE EMOTE BOT ! /dance Developer: N6 Telegram: @O000000000000o_X_o000000000000O '
...
async def MaiiiinE():
    Uid , Pw = '4140236419','408B8A7FCCDA67579C54AF15C165F8DA643EEA131E9F7419A60F3CF816FE1A1A'
    ...
    os.system('clear')
    print(render('LEXYYZ', colors=['white', 'green'], align='center'))
    print('')
